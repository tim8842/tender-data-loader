...
type ParseDataInAgreementParesedData struct {
	...
	parseFunc func(
		...
		agreementParesedData *agreement.AgreementParesedData) (any, error)
	agreementParesedData *agreement.AgreementParesedData
}

func NewParseDataInAgreementParesedData(data []byte, parseFunc func(
	ctx context.Context, logger *zap.Logger, data []byte,
	agreementParesedData *agreement.AgreementParesedData) (any, error),
	agreementParesedData *agreement.AgreementParesedData) *ParseDataInAgreementParesedData {
